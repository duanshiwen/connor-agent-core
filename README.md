...
7. Beta hardening docs: verifies [docs/m24-beta-hardening-decision.md](docs/m24-beta-hardening-decision.md), [docs/credential-operations-runbook.md](docs/credential-operations-runbook.md), [docs/credential-operations-rehearsal.md](docs/credential-operations-rehearsal.md), [docs/production-observability-policy.md](docs/production-observability-policy.md), [docs/release-operations-runbook.md](docs/release-operations-runbook.md), [docs/connector-browser-risk-review-templates.md](docs/connector-browser-risk-review-templates.md), and [docs/storage-journal-fixture-freeze-policy.md](docs/storage-journal-fixture-freeze-policy.md) exist.
